...
#define R_AARCH64_GLOB_DAT  1025	/* Set GOT entry to data address, 0x401 */
#define R_AARCH64_JUMP_SLOT 1026	/* Set GOT entry to code address, 0x402 */
#define R_AARCH64_RELATIVE  1027	/* Add load address of shared object, 0x403 */
